...
public class ExcelUtils {
    ...
    public List<Map<String, String>> getDataList() {
        ...
        for (int i = 2; i < rowCount(); i++) {                                     // ---------------------------------> satır atlatmak için burası
            // get each row
    ...
    public double getCellDataint(int rowNum, int colNum) {
        ...
        try {
            cell = workSheet.getRow(rowNum).getCell(colNum);
            String cellData = cell.toString();
            double cellvalue = Double.valueOf(cellData);
            return cellvalue;
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    ...
    public  List<String> getColumnsNames() {
        ...
        for (Cell cell : workSheet.getRow(1)) {                                 // ---------------------------------> satır atlatmak için burası
            columns.add(cell.toString());
        }
        return columns;
    }
    //=========When you enter the row and column number, returning the value===============//
    public void setCellData(double value, int rowNum, int colNum) {
        Cell cell;
        Row row;
    ...
    public void setCellDataString(String value, int rowNum, int colNum) {
        Cell cell;
        Row row;
    ...
    public void setCellData(double value, String columnName, int row) {
    ...
    public String cellBlankorNot(int rowNum, int colNum){
